import{_ as n,c as e,a,o as i}from"./app-BYt8acor.js";const l={};function c(p,s){return i(),e("div",null,s[0]||(s[0]=[a(`<h2 id="默认-vuepress-文档部署" tabindex="-1"><a class="header-anchor" href="#默认-vuepress-文档部署"><span>默认 vuepress 文档部署</span></a></h2><p>基础的部署流程参考阮一峰大佬的文章：https://www.ruanyifeng.com/blog/2019/09/getting-started-with-github-actions.html</p><p>on: 指定事件触发，可以是 pull 事件也可以是定时器 jobs: 任务，一个任务由多个工作流组成 steps: 步骤，一个任务由多个步骤构成</p><div class="language-text line-numbers-mode" data-highlighter="prismjs" data-ext="text"><pre><code><span class="line">- name：action,一个步骤由多个 action 构成</span>
